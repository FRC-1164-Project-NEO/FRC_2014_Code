...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Get Auto Mode from arrays.vi" Type="VI" URL="../../Auto text File Code/Get Auto Mode from arrays.vi"/>
		<Item Name="Send scripted data to robot.vi" Type="VI" URL="../../Auto text File Code/Send scripted data to robot.vi"/>
		<Item Name="Write Constants to Robot.vi" Type="VI" URL="../../RM Constants/From Ian&apos;s Computer/Write Constants to Robot.vi"/>
		<Item Name="Save Back to the auto text file.vi" Type="VI" URL="../../Auto text File Code/Save Back to the auto text file.vi"/>
		<Item Name="Check if Dashboard is connected to the robot (Dashboard).vi" Type="VI" URL="../../Other code/Check if Dashboard is connected to the robot (Dashboard).vi"/>
		<Item Name="Reload constants wait time.vi" Type="VI" URL="../../Other code/Reload constants wait time.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Read Auto Text File.vi" Type="VI" URL="../../Auto text File Code/Read Auto Text File.vi"/>
			<Item Name="Txt to clean Array (Dashboard).vi" Type="VI" URL="../../RM Constants/From Ian&apos;s Computer/Txt to clean Array (Dashboard).vi"/>
			<Item Name="String Array to DBL Array.vi" Type="VI" URL="../../RM Constants/From Ian&apos;s Computer/String Array to DBL Array.vi"/>
			<Item Name="Check start of line for constant.vi" Type="VI" URL="../../Auto text File Code/Check start of line for constant.vi"/>
			<Item Name="Remove uneeded lines.vi" Type="VI" URL="../../Auto text File Code/Remove uneeded lines.vi"/>
			<Item Name="String slicer.vi" Type="VI" URL="../../RM Constants/From Ian&apos;s Computer/String slicer.vi"/>
			<Item Name="Constant trim.vi" Type="VI" URL="../../RM Constants/From Ian&apos;s Computer/Constant trim.vi"/>
			<Item Name="Array of strings to multi lined string.vi" Type="VI" URL="../../Auto text File Code/Array of strings to multi lined string.vi"/>
			<Item Name="Tokenize by search constant.vi" Type="VI" URL="../../Auto text File Code/Tokenize by search constant.vi"/>
			<Item Name="Remove all spaces and tabs from string.vi" Type="VI" URL="../../Auto text File Code/Remove all spaces and tabs from string.vi"/>
			<Item Name="Clean up Auto scripting.vi" Type="VI" URL="../../Auto text File Code/Clean up Auto scripting.vi"/>
			<Item Name="Split auto name from auto program.vi" Type="VI" URL="../../Auto text File Code/Split auto name from auto program.vi"/>
			<Item Name="Auto scripting split autonmous modes from text.vi" Type="VI" URL="../../Auto text File Code/Auto scripting split autonmous modes from text.vi"/>
			<Item Name="Check if number is changing.vi" Type="VI" URL="../../Other code/Check if number is changing.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC PC Dashboard" Type="EXE">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/Controls/Desktop/Dashboard builds/Dashboard V2/Dashboard V2</Property>
				<Property Name="Bld_modifyLibraryFile" Type="Bool">true</Property>
				<Property Name="Bld_previewCacheID" Type="Str">{F12754D6-B5E0-496F-B50C-3EDB6F368199}</Property>
				<Property Name="Bld_version.build" Type="Int">15</Property>
				<Property Name="Bld_version.major" Type="Int">5</Property>
				<Property Name="Destination[0].destName" Type="Str">Dashboard.exe</Property>
				<Property Name="Destination[0].path" Type="Path">/C/Users/Controls/Desktop/Dashboard builds/Dashboard V2/Dashboard V2/Dashboard.exe</Property>
				<Property Name="Destination[0].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="Destination[0].type" Type="Str">App</Property>
				<Property Name="Destination[1].destName" Type="Str">Support Directory</Property>
				<Property Name="Destination[1].path" Type="Path">/C/Users/Controls/Desktop/Dashboard builds/Dashboard V2/Dashboard V2/data</Property>
				<Property Name="Destination[1].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">2</Property>
				<Property Name="Exe_iconItemID" Type="Ref">/My Computer/Support/App EXE.ico</Property>
				<Property Name="Source[0].itemID" Type="Str">{DB884F63-ACB6-4DA2-ABA6-E3F4B775F078}</Property>
